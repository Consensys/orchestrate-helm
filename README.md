...
| `global.existingSecretName`        | If specified, extra environment variables will be added from externally created secret                   | `nil`                                                       |
...
| `api.existingSecretName`                                 | If specified, extra environment variables will be added from externally created secret                                 | `nil`               |
...
| `keyManager.existingSecretName`          | If specified, extra environment variables will be added from externally created secret                                 | `nil`       |
...
| `txSender.existingSecretName`         | If specified, extra environment variables will be added from externally created secret                                 | `nil`       |
...
| `txListener.existingSecretName`         | If specified, extra environment variables will be added from externally created secret                                 | `nil`       |
